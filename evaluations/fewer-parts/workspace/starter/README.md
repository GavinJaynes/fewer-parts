...
- Pages: `index.html` (library home), `contact.html` (legacy textarea autosizing), `archive.html` (hand-rolled confirmation modal), and `carousel.html` (scroll-snap carousel with application behavior).
